...
public class MyCosts extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel20Layout.createSequentialGroup()
                ...
                .addGroup(jPanel20Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel20Layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(exportProgressLBL, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel20Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel20Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(exportProgressLBL, javax.swing.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void exportButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exportButtonActionPerformed
        ...
        try {
            export.exportFile(bills, income, exportProgressBar);
    ...
    private void billSearchTFCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_billSearchTFCaretUpdate
        ...
        ArrayList<Integer> billSearch = new ArrayList<>();
        ...
        for(int i = 0; i < billSearch.size(); i++){
            
            model.addElement(bills.get(billSearch.get(i)).getDate() + " " + bills.get(billSearch.get(i)).getCategory() + " " + moneyFormat.format(bills.get(billSearch.get(i)).getExpense()));
    ...
    private void importButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_importButtonActionPerformed
        ...
        ArrayList<Bills> newBills = new ArrayList<>();
        ArrayList<Income> newIncome = new ArrayList<>();
